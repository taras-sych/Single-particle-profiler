...
## Microscopy data compatibility:
   ...
   - .tif
   - .txt
   - to adapt any other format, see the format of .txt file and save your data as .txt
   - formats for Picoquant are currently developed
...
### Imaging Single Particle Profiler (iSPP):
https://pubs.acs.org/doi/full/10.1021/acs.nanolett.4c05117
